      ...
      >
        ...
        <div className="flex flex-wrap justify-start px-8 py-4 bg-white shadow-md rounded-lg mb-8 container">
                ...
                <div className="flex items-center mx-4">
                    <input type="radio" id="calories" name="filter" className="appearance-none w-5 h-5 border-2 border-gray-600 checked:bg-blue-600 checked:border-blue-600 mr-2 cursor-pointer" 
                    onClick={() => {
                    ...
                    />
                    <label htmlFor="calories" className="text-md">Calories</label>
                </div>

                <div className="flex items-center mx-4">
                    <input type="radio" id="protein" name="filter" className="appearance-none w-5 h-5 border-2 border-gray-600 checked:bg-blue-600 checked:border-blue-600 mr-2 cursor-pointer" 
                    onClick={() => {
                        let copy = JSON.parse(JSON.stringify(menu)); 
                    ...
                    />
                    <label htmlFor="protein" className="text-md">Protein</label>
                </div>

                <div className="flex items-center mx-4">
                    <input type="radio" id="cal-protein" name="filter" className="appearance-none w-5 h-5 border-2 border-gray-600 checked:bg-blue-600 checked:border-blue-600 mr-2 cursor-pointer" 
                    onClick={() => {
                        let copy = JSON.parse(JSON.stringify(menu)); 
                    ...
                    />
                    <label htmlFor="cal-protein" className="text-md">Cal-Protein Ratio</label>
                </div>
            </div>
